![Deploy_Word_Docs_to_Smart_Contracts_- 📑](https://github.com/Smithy0151/sha256-Word-doc-Converter/assets/115808415/a4209b90-8b0d-4608-b307-d117240c1d33)
...
* Instructions to get started
  *`enable-corepack //This lets you access yarn through the terminal make sure you install node beforehand`
  *`yarn //This installs all the node module and dependcies needed to run scripts`
  *`//Add your blockchain wallets private address and the rpc_url`
  *`node deploy.js`
